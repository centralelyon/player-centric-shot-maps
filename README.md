...
- Use `create_mmpose_files()` from [mmpose_inference.py](https://github.com/centralelyon/tt-player-centric/blob/main/scripts/mmpose_inference.py)
  - Params:
    - video_path  
...
- Use `create_csv_position_using_feet()` from [utils.py](https://github.com/centralelyon/tt-player-centric/blob/main/scripts/utils.py)
...
We need to create a json with these parameters (example: https://github.com/centralelyon/tt-player-centric/blob/main/example/PRITHIKA-PAVADE_vs_SIBEL-ALTINKAYA_camera.json)  
To create this json file we provide the function `create_json_camera()` from [utils.py](https://github.com/centralelyon/tt-player-centric/blob/main/scripts/utils.py)
...
To create the csv with coordinates in the new referential we need to use `create_csv_new_ref()` from [utils.py](https://github.com/centralelyon/tt-player-centric/blob/main/scripts/utils.py)
example:  
...
## 6. Miscellaneous
[BlenderScene.py](https://github.com/centralelyon/tt-player-centric/blob/main/scripts/BlenderScene.py) is to create 3D scene in Blender.  
